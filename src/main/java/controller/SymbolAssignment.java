...
public class SymbolAssignment {
    ...
    private PriorityQueue<uPIFrequency> piFrequencyList; //List of UPIs and frequency
    private BiMap<Integer, String> piTranslate; //List of UPIs and mac addresses
    private List<Integer> piSymbolHashTable; //Array of UPIs with direct addressing
    private int gUPI;
    ...
    public SymbolAssignment() {
        ...
        piSymbolHashTable = new ArrayList<>(97);
        for (int i = 0; i < 97; i++) {
...
//		}
    ...
    String addSymbol(int symbol) { //returns the mac address of a pi
    ...
    void add(String piId) { //Adds a pi to the pool available to have symbols assigned to them
    ...
    class uPIFrequency implements Comparable<uPIFrequency> { //used to store the amount of symbols associated to each pi
